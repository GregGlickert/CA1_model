...
_ = plot_traces(config_file='CA1_config.json', node_ids=[0], report_name='v_report', title='voltage report for PN')

_ = plot_traces(config_file='CA1_config.json', node_ids=[1], report_name='v_report', title='voltage report for AAC')
