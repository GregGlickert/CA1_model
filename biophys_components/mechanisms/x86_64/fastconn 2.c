...
#define install_fastconn install_fastconn_ 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _fastconn_reg() {
  ...
  _initlists();
 	...
 	ivoc_help("help ?1 fastconn /Users/gregglickert/Documents/GitHub/CA1_model/biophys_components/mechanisms/modfiles/fastconn.mod\n");
 }
static int _reset;
